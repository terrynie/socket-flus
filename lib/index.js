...
module.exports = class SocketFlus {
  constructor(options) {
    ...
    this.addConnection(this.url).then((res) => {
      return this;
    });
  }

  async addConnection(urls) {
    this.url = Array.prototype.concat(this.url, typeof urls === 'string' ? urls = [urls] : urls);
    let result = await this._connect(urls);
    this.sockets = Array.prototype.concat(this.sockets, result.sockets);
  }
  ...
  _analyse() {
    ...
    return new Promise((resolve) => {
      ...
      console.log('====================');
      console.log(that._response.length);
      console.log('====================')
